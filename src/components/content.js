...
const Content = () => {
  return (
    <div className='content'>
      ...
      {<img src="https://scontent-arn2-1.xx.fbcdn.net/v/t39.30808-6/279964341_5026589747457733_148937258842395502_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=5f2048&_nc_ohc=Vow8lwghMxUQ7kNvgFClBhi&_nc_ht=scontent-arn2-1.xx&oh=00_AfCfDAWH-oEo8_Llx_ljk4nrPpEmqwD9sPEbrTOPRcmvdQ&oe=66367E0C" id="Sivustaseuraaja_banner" alt="Kuva etusivulta" />}
      </div>
      ...
      <h3>Vastuualueet</h3>
      <p>
        Jenna Manninen: UI-pohja Reactilla, koodin yhdistäminen ja lisäys Renderiin  <br/>
